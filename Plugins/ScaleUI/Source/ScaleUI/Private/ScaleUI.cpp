...
void FScaleUIModule::StartupModule()
{
    ...
    if (SettingsModule != nullptr)
    {
        ...
        TSharedPtr<ISettingsSection> SettingsSection = SettingsModule->RegisterSettings("Editor", "Plugins", SETTING_SECTION_NAME,FText::FromString("ScaleUI"), FText::FromString("Editor scale UI settings"), SettingsObject);
